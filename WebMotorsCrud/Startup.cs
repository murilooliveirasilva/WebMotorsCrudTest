...
using WM.Bussiness.Service;
using WM.Data.Repository;

namespace WebMotorsCrud
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services
            //    .Configure<WM.Data.AppSettings>(Configuration)
            //    .AddSingleton(sp => sp.GetRequiredService<IOptions<WM.Data.AppSettings>>().Value);
